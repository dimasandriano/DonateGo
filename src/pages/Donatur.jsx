			...
			<RootLayout>
				<section className="px-4 py-12 mx-auto max-w-7xl">
					<input
						...
						className="block w-1/3 mb-3 px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg  focus:border-emerald-400  focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-emerald-300"
					/>
